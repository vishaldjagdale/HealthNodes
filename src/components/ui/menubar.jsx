...
const MenubarSubTrigger = React.forwardRef(function MenubarSubTrigger({ className, inset, children, ...props }, ref) {
  return (
...
const MenubarSubContent = React.forwardRef(function MenubarSubContent({ className, ...props }, ref) {
  return (
...
const MenubarContent = React.forwardRef(function MenubarContent({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }, ref) {
  return (
...
const MenubarShortcut = function MenubarShortcut({ className, ...props }) {
